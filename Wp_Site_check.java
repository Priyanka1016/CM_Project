...
public class Wp_Site_chec {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver","C:\\selenium-java-3.141.5\\chromedriver_win32 (2)\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		//https://<advancesimple>:<simple%21%40123>@www.advancesimple.com/"
        String baseUrl = "https://advancesimple.com/";
...
//		    //driver.findElement(By.xpath("//*[@id=\"tdi_59_6c2\"]/div/div/div/div[3]/div")).click();
//	    	WebDriverWait wait = new WebDriverWait(driver, 10);
//	        driver.findElement(By.xpath("//*[@id=\"tdi_59_6c2\"]/div/div/div/div[3]/div/a/span")).click();  
//	        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
//	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"tdi_59_6c2\"]/div/div/div/div[3]/div/a/span")));
