...
System.out.println("----------------------------------");
		//To check below tags in code as  mentioned in checklist
...
for(String check:Notincode)
{
	...
	if(Present == true)
	{
		...
		//To check Contact us page as  mentioned in checklist
...
driver.findElement(By.xpath("//*[@id=\"tool-form\"]/button")).click();
		//To check secure connection on article page
((JavascriptExecutor)driver).executeScript("window.open()");
